...
if ($view) {
    ...
    if ($report) {
        ...
        if (isset($_POST['Submit'])) {
            ...
            // Confirm
            if (!isset($_POST['confirmed'])) {
                $system->confirm(L_CONFIRM_WARNING, L_CONFIRM_WARNING_MSG, './?view=' . $view . '', array("warning" => $warning, "True" => 'Submit'));
            }
        ...
        if (isset($_POST['Ban'])) {
            ...
            // Confirm
            if (!isset($_POST['confirmed'])) {
                $system->confirm(L_CONFIRM_BAN, L_CONFIRM_BAN_MSG, './?view=' . $view . '', array("warning" => $warning, "True" => 'Ban'));
            }
        ...
        if (isset($_POST['tban'])) {
            ...
            // Confirm
            if (!isset($_POST['confirmed'])) {
                $system->confirm(L_CONFIRM_TEMPORARY_BAN, L_CONFIRM_TEMPORARY_BAN_MSG, './?view=' . $view . '', array("warning" => $warning, $tempban => "tempban", "true" => 'tban'));
            }
