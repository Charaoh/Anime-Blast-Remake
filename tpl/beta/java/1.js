...
live: function(t, a) {
	...
	$(window).bind("load", function() {
		...
		var t = document.getElementById("selection").offsetWidth,
		a = document.getElementById("selection").offsetHeight;
		window.resizeTo(t + 16, a + 88),
	...
	$(".character,.skill,.class,.filter,.close-menu,.buy-out,.effects-list>p,.close-character,.close,.save,.shuffle,.statistics>img,.quicky>span").live("click", function(t){
		click.play();
	});
