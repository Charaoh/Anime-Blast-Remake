<div class="transparent"><font class="navfont">{L_CONFIGURATION}</font></div>
...
<tr>
   ...
   <tr>
    <td width="11%"><div align="left"><font class="normfont">Mainpage forums (glued by commas in between if multiple):</font></div></td>
    <td colspan="3"><div align="left">
      <input name="newsContainer" type="text" class="formcss" id="newsContainer" value="{NEWSCONTAINER}" size="40" maxlength="40" />
    </div></td>
  </tr>
   <tr>
