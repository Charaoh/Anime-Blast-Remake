<!-- BEGIN menu -->
<FORM style="padding: 0px; margin: 1em;">
    <INPUT TYPE="button" value="{L_ACCOUNT}" class="globaltab" onClick="parent.location='./control-panel'">
    <INPUT TYPE="button" value="{L_SETTINGS}" class="globaltab"
        onClick="parent.location='./control-panel?mode=settings'">
    <INPUT TYPE="button" value="{L_AVATAR}" class="globaltab" onClick="parent.location='./control-panel?mode=avatar'">
    <INPUT TYPE="button" value="{L_SIGNATURE}" class="globaltab"
        onClick="parent.location='./control-panel?mode=signature'">
</FORM>
<!-- END menu -->
<!-- BEGIN account -->
<div class="regular">
    <div class="title">{L_ACCOUNT}</div>
</div>
<div class="content">
    <table width="100%" border="0" cellspacing="0" cellpadding="4">
        <form action="" method="post" name="register" target="_self">
            ...
            <tr>
                <td width="15%">
                    <div class="justify-content-left">
                        <div class="title">{L_NAME}:</div>
                    </div>
                </td>
                <td width="85%">
                    <div class="justify-content-left">
                        <input name="name" type="text" class="formcss" id="name" value="{NAME}" size="30"
                            maxlength="40" />
                    </div>
                </td>
            </tr>
            <tr>
                <td width="15%">
                    <div class="justify-content-left">
                        <div class="title">{L_PASSWORD}:</div>
                    </div>
                </td>
                <td width="85%">
                    <div class="justify-content-left">
                        <input name="pass" type="password" class="formcss" size="30" maxlength="40" id="pass"
                            autocomplete="off" />
                    </div>
                </td>
            </tr>
            <tr>
                <td width="15%">
                    <div class="justify-content-left">
                        <div class="title">{L_NEW_PASSWORD}:</div>
                    </div>
                </td>
                <td width="85%">
                    <div class="justify-content-left">
                        <input name="newpass" type="password" class="formcss" size="30" maxlength="40" id="newpass"
                            autocomplete="off" />
                    </div>
                </td>
            </tr>
            <tr>
                <td width="15%">
                    <div class="justify-content-left">
                        <div class="title">{L_NEW_PASSWORD_CONFIRM}:</div>
                    </div>
                </td>
                <td width="85%">
                    <div class="justify-content-left">
                        <input name="confirmnewpass" type="password" class="formcss" size="30" maxlength="40"
                            id="confirmnewpass" autocomplete="off" />
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <div class="justify-content-center"><input name="Submit" type="submit" class="formcss"
                            value="{L_SUBMIT}" /></div>
                </td>
            </tr>
        </form>
...
<div class="regular mb-1">
    ...
    <div class="content">
        <ul>
            ...
            <li>
                Down below is also a drop down menu in where you can select your preferred background. After selection,
                you
                can change to this background by clicking "UPDATE".</li>
            <li>A bbcode is supplied to you so you are allowed to show off your achievements to friends here or in
                another
                game's forums.</li>
            </p>
            <br />
            ...
            <div class="justify-content-center">
                <form action="" method="post" name="playercard" target="_self">
                    ...
                    <br />
                    Hide team: <input style="text-transform:none;" name="hideteam" type="checkbox" class="globaltab"
                        id="hideteam" />
                    <br />
                    BBCode: <input style="text-transform:none;" name="playercard" type="input" class="globaltab" id="pc"
                        value="{BBCODE}" />
...
<div class="content">
    ...
    <form action="" method="post" name="register" target="_self">
        <p style="
    float: left;margin-right: 5px;"> Reset account </p><span class="what"
            data-descr="By checking this setting you will reset your game wins, loses, experience, streak and perserve your blast coins, characters, mission progress and forum statistics.">?</span>
        <input name="reset" type="checkbox" class="formcss" id="reset" value="1" />
</div>
<div class="transparent">
    <div class="title">Forum Settings</div>
</div>
...
<div class="content">
    <table width="100%" border="0" cellspacing="0" cellpadding="4">
        ...
        <tr>
            <td width="15%">
                <div class="justify-content-left">
                    <div class="title">{L_TIMEZONE}:</div>
                </div>
            </td>
            <td width="85%">
                <div class="justify-content-left">
                    ...
                    <select id="timezone" name="timezone" class="formcss">
                        ...
                        <option value="43200" {y}>(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka</option>
                    </select>
                </div>
            </td>
        </tr>
        <tr>
            <td width="15%">
                <div class="justify-content-left">
                    <div class="title">{L_LOCATION}:</div>
                </div>
            </td>
            <td width="85%">
                <div class="justify-content-left">
                    <input name="location" type="text" class="formcss" id="location" value="{LOCATION}" size="40"
                        maxlength="80" />
                </div>
            </td>
        </tr>
            ...
            <table width="100%">
                <tr>
                    <td>
                        ...
                        <div class="justify-content-center">
                            <input name="Avi" type="submit" class="formcss" value="{L_SUBMIT}"> <input name="Delete"
                                type="submit" class="formcss" value="{L_DELETE}">
                        </div>
                    </td>
                </tr>
...
<div class="transparent">
    <font class="navfont">{L_SIGNATURE}</font>
</div>
<div class="content">
    <font class="navfont">
        <table width="100%" border="0" cellspacing="0" cellpadding="4">
            <form action="" method="post" name="post" target="_self">
                    ...
                    <td colspan="2">
                        <div class="justify-content-left">
                            ...
                            <input type="button" value="WWW"
                                onclick="wrapText('message','[url=http://link here]','[/url]')" class="formcss" />
                            ...
                            <input type="button" value="Spoiler"
                                onclick="wrapText('message','[spoiler= button text]','[/spoiler]')" class="formcss" />
                ...
                <tr>
                    <td>
                        <div align="center"> <textarea rows="2" name="signature" id="message" cols="20"
                                style="width: 98%; height: 100" class="formcss">{SIGNATURE}</textarea></div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <div align="center"><input name="Submit" type="submit" class="formcss" value="{L_SUBMIT}" />
                        </div>
                    </td>
                </tr>
            </form>
