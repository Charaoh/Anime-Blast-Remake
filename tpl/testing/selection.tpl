<div id="selection" {BG}>
	...
	<div class="christmasImage alts" tabindex="-1">
		<div class="containerImage" role="dialog" aria-model="true">
			<div class="contentImage">
				<p> "Welcome to Anime-Blast's [belated] Christmas Event! Assemble a team of your strongest characters
					and face off against the mighty Saint Nicholas and his Happy Helpers,
					dodge his axes, and avoid getting covered in snow! Successfully defeating Saint Nicholas will yield
					Christmas Cookies which can be redeemed for special prizes in Santa's Shop,
	...
	<div id="middle">
			...
			<div class="option ai" style="opacity: 1;">
				...
				<div class="levels">
					...
					<div class="difficulty one"
						title="Hoohoohoo, santa is waiting for you and be prepared. He and his helpers will give you a chance to earn 1 cookie to use at his shop.">
						<p>EASY</p>
					</div>
					<div class="difficulty two"
						title="The same benefit applies here. Except you are certified to get 1 to 2 cookies, however the AI's will have infinite mana and no cooldowns.">
						<p>MEDIUM</p>
					</div>
					<div class="difficulty three"
						title="You will gain 3 cookies upon victory.. however the AI's have the same benefits as the above, but can use up to 3 skills per turn.">
						<p>LEGEND</p>
					</div>
				</div>
			</div>
		...
		<div class="shop-2">
			...
			<img src="./tpl/christmas/css/images/brandish.png" class="render-shop">
			...
			<div class="sales">
				...
				<div class="sale" data-rel="misc">
					<div class="categorybtn"></div>
					<p>Santa's Shop</p><img src="./tpl/christmas/css/images/santaShop.png" class="fl-l">
				</div>
				...
				<div id="misc" style="display:none;transform: skewX(30deg);">
					<h2 class="headerSantaShop">Santa's special event!</h2>
					...
					<span class="eventPack" style="margin-left: 35%;display: block;">
						<h2>BC Conversion</h2>
						<span class="eventItem" id="1" title="This box gives you a 50% chance of getting cookies">
						...
						</span><span class="eventItem" id="2"
							title="This box gives you a 100% chance of getting up to 3 cookies">
					...
					<span class="eventPack" style="margin-right: 25%;">
						...
						<span class="eventItem" id="9"
							title="Gacha Event Box - Has a 50% chance of getting a random box, 35% chance of getting a medium box, 
                    10% chance of getting a discord box, 3.5% chance of repeating and 1.5% chance of getting Gif character">
					...
					<span class="eventPack">
						...
						<span class="eventItem" id="8"
							title="Unlock a special animated version of a character! (Gif Character)">
							<span class="itemHover three"></span>
							<img src="https://www.anime-blast.com/tpl/christmas/css/images/gifCharacter.png"
								style="clear: both;float: left;">
							<span class="cost">
								<img src="https://www.anime-blast.com/tpl/christmas/css/images/cookie.png"
									style="vertical-align: bottom;"> 500
							</span>
						</span>
					</span>
				</div>
