...
<input type="button" value="Spoiler" onclick="wrapText('message','[spoiler= button text]','[/spoiler]')" class="formcss" /></div></td>
...
<td valign="top"><div align="center" class="normfont">{AUTHOR}{STATUS}<br />{RANK}<br />{AVATAR}<br />
</div></td>
<td valign="top">
...
<!-- BEGIN reply -->
<div class="content">
<div class="content"><font class="navfont">{L_REPLY}</font></div>
...
<tr class="content"><td colspan="5"> {L_TITLE}</td></tr>
  <tr class="content">
    <td width="1%">&nbsp; </td>
