<div class="transparent"><font class="navfont">{L_AVATAR_SETTINGS}</font></div>

<div class="content">
<form action="" method="post" name="config" target="_self">
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
   ...
   <tr>
        ...
        <td colspan="2"><div align="left"><font class="normfont">
          <select name="avatar" class="globaltab">
  ...
  <tr>
    ...
    <td colspan="2"><div align="left"><input name="avatar_filesize" type="text" class="globaltab" id="name" value="{FILESIZE}" size="4" maxlength="40" /></div></td>
  ...
  <tr>
    ...
    <td colspan="2"><div align="left"><input name="avatar_height" type="text" class="globaltab" id="name" value="{HEIGHT}" size="4" maxlength="40" /></div></td>
	<td><div align="left"><font class="normfont">{L_HEIGHT_MSG}</font></div></td>
  </tr>
  <tr>
    <td ><div align="left"><font class="normfont">{L_WIDTH}:</font></div></td>
    <td colspan="2"><div align="left"><input name="avatar_width" type="text" class="globaltab" id="name" value="{WIDTH}" size="4" maxlength="40" /></div></td>
