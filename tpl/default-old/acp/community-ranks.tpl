...
<!-- BEGIN row -->
<tr  class="row{CLASS}"><form action="" method="post" name="row" target="_self"><td><font class="normfont">{ID}</font></td><td><font class="normfont">{TITLE} {INFO}</font></td><td><input type="hidden" name="id" value="{ID}"><input name="edit" type="submit" class="globaltab" value="{L_EDIT}"/><input name="delete" type="submit" class="globaltab" value="{L_DELETE}"/></font></td></form>
</tr><!-- END row -->
</table>
</div>

<!-- BEGIN addrank -->
<div class="transparent"><font class="navfont">{L_ADD_RANK}</font></div>
<div class="content">
...
<select id="special" name="special" class="globaltab"> 
...
<option value="1">{L_YES}</option> 
  ...
  <tr>
    ...
    <td><div align="left">
      <input name="postcount" type="text" class="globaltab" size="4" maxlength="4" id="postcount" />
      </div></td>
  </tr>
  <tr>
    <td colspan="2"><div align="center">
      <input type="submit" name="newrank" value="{L_SUBMIT}" class="globaltab"/>
    </div></td>
  </tr>
</table>
</form>
...
<!-- BEGIN edit -->
<div class="transparent"><font class="navfont">{L_EDIT_RANK}</font></div>
<div class="content"><table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td>
...
<option value="1"{SPECIAL}>Yes</option> 
  ...
  <tr>
    <td width="11%"><div align="left"><font class="normfont">{L_POSTS}:</font></div></td>
    <td><div align="left">
      <input name="postcount" type="text" class="globaltab" size="4" maxlength="4" id="postcount" value="{POSTCOUNT}"/>
      &nbsp;</div></td>
  </tr>
  <tr>
    <td colspan="2"><div align="center">
