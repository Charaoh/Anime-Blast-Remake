<!-- BEGIN group -->
<div class="transparent">{L_GROUP_SETTINGS}</div>
<div class="content">
...
<div class="transparent">{L_ADD_MEMBER}</div>
<div class="content">
<form action="" method="post" target="_self">
<table width="100%">
<tr>
...
<div class="transparent">{L_MEMBERS}</div>
<div class="content">
<form action="" method="post" target="_self">
...
<div class="transparent">{L_SELECT_GROUP}</div>
<div class="content">
<form action="" method="post" target="_self">
<center>
<table width="400">
...
<div class="transparent">{L_NEW_GROUP}</div>
<div class="content">
<form action="" method="post" target="_self">
<table width="100%">
