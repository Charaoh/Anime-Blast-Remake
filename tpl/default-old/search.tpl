...
{TEXT}</div>
<div align="right">
<INPUT TYPE="button" value ="{L_VIEW}" class="formcss" onClick="parent.location='./?s=viewtopic&amp;t={TOPIC_ID}'">
</div>
</div>
...
<div class="transparent"><font class="navfont">{L_SEARCH}</font></div>
<div class="content">
<table width="100%" border="0" cellspacing="2" cellpadding="4">
